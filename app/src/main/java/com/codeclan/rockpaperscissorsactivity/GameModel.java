...
//    }
    ...
    public String whoWon() {
        ...
        if (this.hand.equals(this.computerHand)) {
            return "It's a draw! The human played :" + hand + ", the computer played : " + computerHand;
            ...
            return "Player wins! The human played :" + hand + ", the computer played : " + computerHand;
        } else {
            return "Computer wins! The human played :" + hand + ", the computer played : " + computerHand;
        }
    }
